...
INTERACTIVE_MODE = False  # on server make this False, because there is no GUI
TILE_HEIGHT = 256
TILE_WIDTH = 256
...
test_checkpoint_path = "../cloudcontainer/drone/saved_models/best_model.ckpt"
...
cv2.imwrite("../cloudcontainer/drone/saved_full_images/full_semantic_segmentation_prediction_image.jpg", reconstructed_img)
