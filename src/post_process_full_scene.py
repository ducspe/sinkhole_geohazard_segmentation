...
NUM_EROSION_ITERATIONS = 10
NUM_DILATION_ITERATIONS = 10
# End of script parameters section

ground_truth_label_img = cv2.imread("../cloudcontainer/drone/saved_full_images/threeclass_img_from_originallabel.jpg", cv2.IMREAD_GRAYSCALE)
threeclass_label_img = cv2.imread("../cloudcontainer/drone/saved_full_images/full_semantic_segmentation_prediction_image.jpg", cv2.IMREAD_GRAYSCALE)
...
cv2.imwrite("../cloudcontainer/drone/saved_full_images/full_instance_segmentation_prediction_image.jpg", labels_colored * 255.0)
...
if INTERACTIVE_MODE:
    ...
    cv2.resizeWindow("Ground truth", 600, 600)
    cv2.imshow("Ground truth", ground_truth_label_img)
